...
class MarginalDiBS(DiBS):
    ...
    def __init__(self, *,
        ...
        self.eltwise_log_marginal_likelihood_observ = vmap(lambda g, x_ho:
             inference_model.interventional_log_marginal_prob(g, None, x_ho, jnp.zeros_like(self.x_ho), None), (0, None), 0)
...
class JointDiBS(DiBS):
    ...
    def __init__(self, *,
        ...
        self.eltwise_log_likelihood_observ = vmap(lambda g, theta, x_ho:
            inference_model.interventional_log_joint_prob(g, theta, x_ho, jnp.zeros_like(self.x_ho), None), (0, 0, None), 0)
