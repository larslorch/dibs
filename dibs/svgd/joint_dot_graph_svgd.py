...
class JointDotProductGraphSVGD:
    """
    ...
    def __init__(self, *, n_vars, n_dim, kernel, target_log_prior, target_log_joint_prob, target_log_joint_prob_no_batch, alpha, beta, gamma, tau, n_grad_mc_samples,
        ...
        super(JointDotProductGraphSVGD, self).__init__()
    ...
    def init_core_functions(self):
        ...
        if self.grad_estimator_x == 'score':
            ...
            # [d, k, 2], [d, d], [n_graphs, d, d], [1,], [1,] -> [n_graphs]
            ...
            eltwise_grad_x_log_joint_prob_hard = jit(vmap(grad_x_log_joint_prob_hard, (None, None, 0, None, None), 0))
        ...
        # [n_graphs, d, d], [d, d], [1, ] -> [n_graphs, d, d]
    ...
    def make_metrics(self, eltwise_log_likelihood, x_ho, target):
        ...
        eltwise_log_likelihood: [N, d, d], [N, d, d] -> [N, ]
