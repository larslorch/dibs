...
'''Structure learning related'''

def acyclic_constr_(mat, n_vars):
    '''
...
acyclic_constr = jit(acyclic_constr_, static_argnums=(1,))


def acyclic_constr_nograd_(mat, n_vars):
    '''
        Differentiable acyclicity constraint from
        Yu et al 2019
        http://proceedings.mlr.press/v97/yu19a/yu19a.pdf
...
acyclic_constr_nograd = jit(acyclic_constr_nograd_, static_argnums=(1,))
elwise_acyclic_constr_nograd = jit(vmap(acyclic_constr_nograd_, (0, None), 0), static_argnums=(1,))

def eltwise_acyclic_constr_(mat, n_vars):
    '''
...
eltwise_acyclic_constr = jit(eltwise_acyclic_constr_, static_argnums=(1,))
